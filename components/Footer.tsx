      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-8 text-slate-500">
              Empowering the next generation of healthcare professionals and scholars. Our commitment to practical excellence ensures world-class outcomes for our students.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm font-semibold">
              <li><Link href="/admissions" className="hover:text-medical-primary transition-colors">Admissions 2026-27</Link></li>
              ...
              <li><Link href="/downloads" className="hover:text-medical-primary transition-colors">Prospectus</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm font-semibold">
              <li><Link href="/nursing/bsc" className="hover:text-medical-primary transition-colors">B.Sc. Nursing</Link></li>
              <li><Link href="/nursing/gnm" className="hover:text-medical-primary transition-colors">GNM Program</Link></li>
              <li><Link href="/nursing/anm" className="hover:text-medical-primary transition-colors">ANM Diploma</Link></li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white text-xs font-black uppercase tracking-[0.2em] mb-10">Get In Touch</h4>
            <ul className="space-y-6 text-sm">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 text-medical-primary mr-4 shrink-0" />
                <span className="text-slate-300 leading-normal">123 Sunrise Campus, Medical Road,<br />District City, State - 456789</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-medical-primary mr-4 shrink-0" />
                <a href="tel:+911234567890" className="text-slate-300 font-bold hover:text-white">+91 12345 67890</a>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-medical-primary mr-4 shrink-0" />
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] text-slate-600 font-bold uppercase tracking-widest gap-6">
          ...
          <div className="flex space-x-8">
            ...
            <Link href="/mandatory-disclosure" className="hover:text-white">Full Disclosure</Link>
          </div>
        </div>
      </div>
    </footer>
